    ...
    public function evaluate(
        ...
        return new Issue(
            ...
            context: [
                ...
                'narrowed_by_weight' => $resolution->narrowedByWeight,
                'eliminated_by_weight' => $resolution->candidatesEliminated(),
            ],
            variant: $resolution->narrowedByWeight ? 'narrowed' : 'unnarrowed',
